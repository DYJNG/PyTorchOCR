...
from pytocr.data.imaug.iaa_augment import IaaAugment
from pytocr.data.imaug.random_crop_data import is_poly_outside_rect
...
class CopyPaste(object):
    ...
    def __call__(self, data):
        ...
        for poly, tag in zip(select_polys, select_ignores):
            box_img = self.get_rotate_crop_image(ext_image, poly)
