...
class MakePseGt(object):
    ...
    def __call__(self, data):
        ...
        for i in range(self.kernel_num):
            ...
            rate = 1.0 - (1.0 - self.min_shrink_ratio) / (
                self.kernel_num - 1) * i
        ...
        data["gt_text"] = gt_kernels[0]   # 最大的kernel  batch * H * W
        data["gt_kernels"] = gt_kernels[1:] # data["gt_kernels"] = gt_kernels[0:] TODO: batch * kernel_num-1 * H * W
        data["mask"] = training_mask.astype("float32")   # training_mask  batch * H * W
        return data
