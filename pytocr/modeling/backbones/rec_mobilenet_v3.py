...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, cnf: InvertedResidualConfig, norm_layer: Callable[..., nn.Module],
        ...
        self.conv2 = ConvBNActivation(cnf.expanded_channels, cnf.expanded_channels, kernel_size=cnf.kernel,
                                      stride=(stride, 1), dilation=cnf.dilation, groups=cnf.expanded_channels,
                                      norm_layer=norm_layer, activation_layer=activation_layer)
        if cnf.use_se:
...
class MobileNetV3(nn.Module):
    ...
    def __init__(
        ...
        layers.append(ConvBNActivation(in_channels, firstconv_output_channels, kernel_size=3, stride=2, norm_layer=norm_layer,
        ...
        self.out_channels = lastconv_output_channels
...
def _mobilenet_v3_conf(arch: str, width_mult=1.0, use_se=True, _reduced_tail=False, _dilation=False):
    ...
    if arch == "large":
        inverted_residual_setting = [
            ...
            bneck_conf(40, 5, 120, 40, True and use_se, "RE", 1, 1),
            bneck_conf(40, 3, 240, 80, False, "HS", 1, 1),  # C3   stride 2->1
        ...
        inverted_residual_setting = [
            ...
            bneck_conf(24, 5, 96, 40, True and use_se, "HS", 1, 1),  # C3  stride 2->1
