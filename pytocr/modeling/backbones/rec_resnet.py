...
def conv3x3(in_planes: int, out_planes: int, stride: _size_2_t = 1, groups: int = 1, dilation: int = 1) -> nn.Conv2d:
    """3x3 convolution with padding"""
    return nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride,
                     padding=dilation, groups=groups, bias=False, dilation=dilation)


def conv1x1(in_planes: int, out_planes: int, stride: _size_2_t = 1) -> nn.Conv2d:
    """1x1 convolution"""
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv2 = conv3x3(width, width, (stride, 1), groups, dilation)
